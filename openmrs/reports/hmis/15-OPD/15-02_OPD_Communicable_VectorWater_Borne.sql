...
FROM obs o 
  ...
  INNER JOIN concept_reference_term_map_view icd ON o.value_coded = icd.concept_id AND icd.code IN ('A86', 'B74.9', 'B54','B50.9','B51.9','A90','B55.9')
...
GROUP BY cn.name
ORDER BY FIELD(icd.code,'A86', 'B74.9', 'B54','B50.9','B51.9','A90','B55.9');