...
FROM obs o 
  ...
  INNER JOIN concept_reference_term_map_view icd ON o.value_coded = icd.concept_id AND icd.code IN ('E04', 'E14','E46','E50','E66','D64','G62')
...
GROUP BY cn.name
ORDER BY FIELD(icd.code,'E04', 'E14','E46','E50','E66','D64','G62');