...
FROM obs o 
  ...
  INNER JOIN concept_reference_term_map_view icd ON o.value_coded = icd.concept_id AND icd.code IN ('B20', 'A54','N49','N89.8','N74','A54.3','N76.6','N50.8','A55','A51')
...
GROUP BY cn.name
ORDER BY FIELD(icd.code,'B20', 'A54','N49','N89.8','N74','A54.3','N76.6','N50.8','A55','A51');