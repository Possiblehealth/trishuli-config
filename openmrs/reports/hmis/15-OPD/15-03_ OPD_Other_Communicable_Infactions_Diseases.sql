...
FROM obs o 
  ...
  INNER JOIN concept_reference_term_map_view icd ON o.value_coded = icd.concept_id AND icd.code IN ('A01.0', 'A09', 'A06.9','A03.9','K52.9','A00.9','B82.9','R17','B15.9','B17','E86')
...
GROUP BY cn.name
ORDER BY FIELD(icd.code,'A01.0', 'A09', 'A06.9','A03.9','K52.9','A00.9','B82.9','R17','B15.9','B17','E86');